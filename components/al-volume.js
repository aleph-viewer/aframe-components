const AlVolumeEvents = {
  DEFAULT_RENDER_STEPS: "al-default-render-steps",
  ERROR: "al-volume-error",
  LOADED: "al-volume-loaded",
  SLICES_MAX_INDEX: "al-volume-slices-max-index",
  VOLUME_RAY_REQUEST: "al-volume-ray-requested",
  VOLUME_RAY_CAST: "al-volume-ray-cast"
}

const AlVolumeCastType = {
  CREATE: "create",
  DRAG: "drag"
}
  ...
  handleStack(stack) {
    ...
    switch (this.data.displayMode) {
      ...
      case DisplayMode.VOLUME: {
        // Get LUT Canvas
        const lutCanvases = el.sceneEl.parentEl.querySelector(
          "#lut-canvases"
        );
